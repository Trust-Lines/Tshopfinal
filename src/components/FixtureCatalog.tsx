  ...
  return (
    <section className="py-12 sm:py-16 bg-white">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        {/* Prominent Centered View All Products Radius Button */}
        <div className="mt-12 sm:mt-16 flex justify-center">
          <button
            ...
            className="inline-flex items-center gap-3 px-8 sm:px-12 py-3.5 sm:py-4 rounded-full bg-[#b93838] hover:bg-[#a53030] active:scale-[0.98] text-white font-bold text-sm sm:text-base shadow-lg shadow-red-900/15 hover:shadow-xl hover:shadow-red-900/25 transition-all duration-200 cursor-pointer group"
          >
